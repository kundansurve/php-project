        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            // Bind variables to the prepared statement as parameters
                    ...
                    if($data = $result->fetch_assoc()){
                            $sql2 = "INSERT INTO developersinfo (userid) VALUES (?)";
                        if($stmt2 = mysqli_prepare($link, $sql2)){
                                mysqli_stmt_bind_param($stmt2, "s", $data['id']);
...
<div class="container" style="display:flex;justify-content:center;align-items:center;width:100%;height:90vh">
    <div class="wrapper">
        <h2>Sign Up</h2>
